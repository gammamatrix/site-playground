...
use Playground\Models\Interfaces\WithMatrixInterface;
 ...
 */
class User extends BaseUser implements MustVerifyEmail, Sanctum\Contracts\HasApiTokens, WithCreatorInterface, WithMatrixInterface, WithModifierInterface
{
    use Notifiable;
